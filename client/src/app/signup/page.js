...
export default function Signup() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert("WELCOME TO THE DEVINO. Registration Successful!");
  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center p-6">
      ...
      <h2 className="text-4xl font-bold mb-8 text-red-600 uppercase">
        Join the Ranks
      </h2>

      <form
        onSubmit={handleSubmit}
        className="flex flex-col gap-6 w-full max-w-md border border-red-900/30 p-8 bg-zinc-900/40 rounded-lg"
      >
        ...
        <input
          ...
          required
          className="bg-black border-b border-red-900 p-3 outline-none"
          onChange={(e) =>
        ...
        <button
          type="submit"
          className="bg-red-600 hover:bg-red-700 text-white py-3 rounded"
        >
          Get Started
        </button>
